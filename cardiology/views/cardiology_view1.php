...
<div class="container" style="width:95%;">
	<div class="row" style="margin-top:55px;">
	  <div class="col-md-2 ">
		<?php echo Modules::run('leftmenu/cardiology',$pid,$clinic_id); //runs the available left menu for preferance ?>
	  </div>
	  <div class="col-md-10 " >
	  <div class="panel panel-default" style="margin-bottom:0px;">
			<div class="panel-heading"><b><?php
			echo "Cardiology Overview"; 
			...
			<div class="panel panel-default"  style="padding:2px;margin-bottom:1px;" >
				...
				<div class="panel-heading" ><b>Cardiology Clinic Visits</b></div>
					<?php
						//print_r($clinic_visit_list);
						if (!empty($cardiology_visit_list)){
							echo '<table class ="table table-condensed table-hover">';
								for ($i=0; $i < count($cardiology_visit_list); ++$i){
									echo '<tr ';
										echo 'style="cursor:pointer;"  onclick="self.document.location=\''.site_url("clinic/visit_view/".$cardiology_visit_list[$i]["clinic_visits_id"]).'?CONTINUE=\';"';
									echo '>';
										echo '<td>'.$cardiology_visit_list[$i]["DateTimeOfVisit"].'</td>';
										echo '<td>'.$cardiology_visit_list[$i]["clinic_name"].'</td>';
										echo '<td>'.$cardiology_visit_list[$i]["Title"].' '.$cardiology_visit_list[$i]["FirstName"].' '.$cardiology_visit_list[$i]["OtherName"].'</td>';
										if ($cardiology_visit_list[$i]["status"] == null){
